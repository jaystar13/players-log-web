...
export default function EditProfileScreen({ onBack, onSaveComplete }: EditProfileScreenProps) {
    ...
    try {
      ...
      const { error } = await supabase.auth.updateUser({
        data: {
          nickname,
          bio,
          // avatar_url is not updated here as it's managed by social provider
          socials
        }
      });
